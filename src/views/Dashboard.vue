      ...
      <div class="top-content">
        ...
        <div class="profile-section">
          ...
          <div class="profile-info">
            ...
            <p class="weather-info">今日多云转晴，20℃ - 25℃!</p>
          </div>
        </div>
          ...
          <div class="card-right">
            ...
            <div class="card-stats">
              ...
              <span class="growth-rate" :class="getGrowthClass(dashboardData.views_growth)">
                <el-icon v-if="dashboardData.views_growth > 0"><CaretTop /></el-icon>
                <el-icon v-else-if="dashboardData.views_growth < 0"><CaretBottom /></el-icon>
          ...
          <div class="card-right">
            ...
            <div class="card-stats">
              ...
              <span class="growth-rate" :class="getGrowthClass(dashboardData.visitors_growth)">
                <el-icon v-if="dashboardData.visitors_growth > 0"><CaretTop /></el-icon>
                <el-icon v-else-if="dashboardData.visitors_growth < 0"><CaretBottom /></el-icon>
          ...
          <div class="card-right">
            ...
            <div class="card-stats">
              ...
              <span class="growth-rate" :class="getGrowthClass(dashboardData.comments_growth)">
                <el-icon v-if="dashboardData.comments_growth > 0"><CaretTop /></el-icon>
                <el-icon v-else-if="dashboardData.comments_growth < 0"><CaretBottom /></el-icon>
          ...
          <div class="card-right">
            ...
            <div class="card-stats">
              ...
              <span class="growth-rate" :class="getGrowthClass(dashboardData.users_growth)">
                <el-icon v-if="dashboardData.users_growth > 0"><CaretTop /></el-icon>
                <el-icon v-else-if="dashboardData.users_growth < 0"><CaretBottom /></el-icon>
    ...
    <el-card class="quick-access-card" shadow="hover">
      ...
      <div class="quick-access-content">
        <div class="quick-links">
          <div class="link-item" @click="openLink('https://your-project-website.com')">
            <span class="link-text">项目官网</span>
            <el-icon class="link-icon"><Right /></el-icon>
          </div>
          <div class="link-item" @click="openLink('https://your-docs-website.com')">
            <span class="link-text">文档</span>
            <el-icon class="link-icon"><Right /></el-icon>
          </div>
          <div class="link-item" @click="openLink('https://gitee.com')">
            <span class="link-text">Gitee</span>
            <el-icon class="link-icon"><Right /></el-icon>
          </div>
          <div class="link-item" @click="openLink('https://your-blog.com')">
